 ...
 * contents of the {@link BNotePadProvider}.
 *
 ...
 */
public class BNotesList extends ListActivity {
    ...
    private static final String[] PROJECTION = new String[] {
            BNotePad.BNotes._ID, // 0
            BNotePad.BNotes.COLUMN_NAME_TITLE, // 1
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getData() == null) {
            intent.setData(BNotePad.BNotes.CONTENT_URI);
        }
        ...
        Cursor cursor = managedQuery(
            ...
            BNotePad.BNotes.DEFAULT_SORT_ORDER  // Use the default sort order.
        );
        ...
        String[] dataColumns = { BNotePad.BNotes.COLUMN_NAME_TITLE } ;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.addIntentOptions(Menu.CATEGORY_ALTERNATIVE, 0, 0,
                new ComponentName(this, BNotesList.class), null, intent, 0, null);
