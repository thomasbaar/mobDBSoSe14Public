 ...
 */
public class BNoteEditor extends Activity {
    // For logging and debugging purposes
    private static final String TAG = "BNoteEditor";
    ...
    protected void onResume() {
        ...
        if (mCursor != null) {
            ...
            if (mState == STATE_EDIT) {
                ...
                int colTitleIndex = mCursor.getColumnIndex(BNotePad.BNotes.COLUMN_NAME_TITLE);
            ...
            int colNoteIndex = mCursor.getColumnIndex(BNotePad.BNotes.COLUMN_NAME_NOTE);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (mState == STATE_EDIT) {
            ...
            menu.addIntentOptions(Menu.CATEGORY_ALTERNATIVE, 0, 0,
                    new ComponentName(this, BNoteEditor.class), null, intent, 0, null);
        }
    ...
    private final void performPaste() {
        ...
        if (clip != null) {
            ...
            if (uri != null && BNotePad.BNotes.CONTENT_ITEM_TYPE.equals(cr.getType(uri))) {
    ...
    private final void updateNote(String text, String title) {
        ...
        values.put(BNotePad.BNotes.COLUMN_NAME_MODIFICATION_DATE, System.currentTimeMillis());
        ...
        if (mState == STATE_INSERT) {
            ...
            values.put(BNotePad.BNotes.COLUMN_NAME_TITLE, title);
        } else if (title != null) {
            // In the values map, sets the value of the title
            values.put(BNotePad.BNotes.COLUMN_NAME_TITLE, title);
        }
        ...
        values.put(BNotePad.BNotes.COLUMN_NAME_NOTE, text);
    ...
    private final void cancelNote() {
        if (mCursor != null) {
            if (mState == STATE_EDIT) {
                ...
                mCursor = null;
                ContentValues values = new ContentValues();
                values.put(BNotePad.BNotes.COLUMN_NAME_NOTE, mOriginalContent);
