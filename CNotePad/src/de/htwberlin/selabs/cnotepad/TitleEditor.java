...
public class TitleEditor extends Activity {
     ...
     */
    public static final String EDIT_TITLE_ACTION = "de.htwberlin.selabs.cnotepad.action.EDIT_TITLE";
    ...
    protected void onPause() {
        ...
        if (mCursor != null) {
            ...
            values.put(CNotePad.CNotes.COLUMN_NAME_TITLE, mText.getText().toString());
